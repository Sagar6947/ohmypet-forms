!(function (t, e) {
  ...
  var s = {
    ...
    errorTemplate: "<li style='width:65%;margin-left:auto;'></li>",
  };
  r.prototype = {
    asyncSupport: !0,
          ...
          this._ui.$errorsWrapper
            ...
            .append(
              h(this.options.errorTemplate)
                .addClass("parsley-" + t)
                .html(i || ( this._ui.errorsWrapperId == 'parsley-id-multiple-haircut_size')? '  Hair lenght is required':((this._ui.errorsWrapperId == 'parsley-id-multiple-spa_includes')? 'Select any one service, it is mandatory':((this._ui.errorsWrapperId == 'parsley-id-12')? 'Upload profile Image':this._getErrorMessage(r))))
            );
